<template> 
  <nav class="relative px-8 h-[72px] bg-myYellow">
    ...
    <div class="container flex justify-between items-center mx-auto max-w-5xl h-full">
      <button
        type="button"
        class="peer block py-6 w-12 h-8 text-sm text-gray-500 bg-center bg-no-repeat bg-[length:24px_24px] bg-menu-toggle rounded-md focus:outline-none focus:ring-2 focus:ring-gray-200 md:hidden"
      >
